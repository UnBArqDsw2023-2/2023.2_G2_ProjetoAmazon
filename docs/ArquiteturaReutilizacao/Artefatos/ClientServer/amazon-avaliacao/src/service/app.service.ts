...
export class AppService {
  getHello(): any {
    ...
    <html>
        ...
        <body>
            <button type="button" onclick="window.location.href='/avaliacao'";>Avaliação de Produtos</button>
            <br><br><br>
            <button type="button" onclick="window.location.href='/pontos'";>Troca de Pontos</button>
            <br><br><br>
            <button type="button" onclick="window.location.href='https://www.amazon.com'";>Amazon.com</button>
            <br><br><br>
